...
export const getFileIcon = (fileName, iconType) => {
  ...
  if (fileName.endsWith(".md")) return ICONS.markdown;
  if (fileName.endsWith(".pdf")) return ICONS.pdf;
  if (fileName.endsWith(".git")) return ICONS.git;
  return ICONS.markdown;
};

export const RESUME_PDF_PATH = "/PriyanshuSharma_Resume.pdf";
